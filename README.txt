...
* Fix wp_count_terms() to use array argument form
* Fix wp_add_inline_style() registration moved into wp_enqueue_scripts hook
* Fix get_template_part() passed integer instead of string
